...
| ADR-0015 | Node reference fingerprint (`fingerprint-schemas.mjs`) + CI parity | Matches `@chassis/types` workspace layout | Replaced Python manifest filenames with committed `fingerprint.sha256` |
