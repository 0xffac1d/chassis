...
use crate::attest::CH_PROVENANCE_COSIGN_VERIFY_FAILED;
use crate::diff::{
...
use crate::scanner::{CH_SCANNER_FINDING, CH_SCANNER_SARIF_MALFORMED};
use crate::spec_index::{
    CH_SPEC_ACCEPTANCE_MISSING, CH_SPEC_CLAIM_IMPL_MISSING, CH_SPEC_CLAIM_TEST_MISSING,
    CH_SPEC_DUPLICATE_CLAIM_REF, CH_SPEC_DUPLICATE_ID, CH_SPEC_INDEX_SCHEMA,
    CH_SPEC_INVALID_TASK_EDGE, CH_SPEC_MARKDOWN_EMPTY_FENCE, CH_SPEC_MARKDOWN_MULTIPLE_FENCES,
    CH_SPEC_MARKDOWN_NO_FENCE, CH_SPEC_ORPHAN_TASK, CH_SPEC_RELATED_TASK_MISSING,
    CH_SPEC_SOURCE_PARSE, CH_SPEC_TOUCHED_PATH_UNCOVERED, CH_SPEC_UNBOUND_REQUIREMENT,
    CH_SPEC_UNKNOWN_CLAIM_REF,
};
...
const CH_TRACE_PARSE_ERROR: &str = "CH-TRACE-PARSE-ERROR";
...
fn kernel_wire_ch_rules() -> BTreeSet<String> {
    [
        ...
        crate::gate::rule_id::GIT_METADATA_REQUIRED,
        crate::gate::rule_id::CONTRACT_INVALID,
        "CH-GATE-CONTRACT-MALFORMED",
        crate::gate::rule_id::SUBSYSTEM_FAILURE,
        crate::gate::rule_id::REGISTRY_MALFORMED,
        crate::gate::rule_id::SCHEMA_INVALID,
        crate::gate::rule_id::SCANNER_EVIDENCE_REQUIRED,
        CH_SCANNER_FINDING,
        CH_SCANNER_SARIF_MALFORMED,
        CH_SPEC_MARKDOWN_NO_FENCE,
        CH_SPEC_MARKDOWN_MULTIPLE_FENCES,
        CH_SPEC_MARKDOWN_EMPTY_FENCE,
        CH_SPEC_SOURCE_PARSE,
        CH_SPEC_DUPLICATE_ID,
        CH_SPEC_ACCEPTANCE_MISSING,
        CH_SPEC_INDEX_SCHEMA,
        CH_SPEC_UNBOUND_REQUIREMENT,
        CH_SPEC_UNKNOWN_CLAIM_REF,
        CH_SPEC_INVALID_TASK_EDGE,
        CH_SPEC_ORPHAN_TASK,
        CH_SPEC_RELATED_TASK_MISSING,
        CH_SPEC_DUPLICATE_CLAIM_REF,
        CH_SPEC_CLAIM_IMPL_MISSING,
        CH_SPEC_CLAIM_TEST_MISSING,
        CH_SPEC_TOUCHED_PATH_UNCOVERED,
    ]
    .into_iter()
    .map(|s| s.to_string())
    .collect()
