...
//! `trace-graph`, `drift-report`, `diagnostic`, `release-gate`, `scanner-summary`,
...
use chassis_core::artifact::{
    ...
    validate_in_toto_statement_value, validate_release_gate_value, validate_scanner_summary_value,
...
fn main() -> ExitCode {
    ...
    let result = match kind.as_str() {
        ...
        "scanner-summary" => validate_scanner_summary_value(&value),
